...
plot4Data<-function(a,type="WINDOWS")
...
## graphic device, type="PNG" to generate png file with resolution=480x480
{
    ...
    else if (type=="PNG") png("plot4.png",width=480,height=480)
    else return
    par(mfrow=c(2,2))
    plot(a$DateTime,a$Global_active_power, col="black",xlab=" ",main=NULL,
         type="l",ylab="Global Active Power")
    plot(a$DateTime,a$Voltage, col="black",main=NULL,
    ...
    legend("topright", col = c("black","red","blue"), pch="_",bty="n",
           legend = c("Sub_metering_1", "Sub_metering_2","Sub_metering_3"))
    plot(a$DateTime,a$Global_reactive_power, col="black",main=NULL,
